...
Now that you've had a basic introduction to the `Nodes` collection, specializing in `Subgraphs`, you might want to head on over to the `Agent` docs:

1. [Rust Agent](./rs/README.md)

You may progress to other sections too:
