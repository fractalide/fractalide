...
self = rec { # use one line only to insert a node (utils/new_node.py sorts this list)
  ...
  msg_action = callPackage ./ip/action {};
  msg_clone = callPackage ./ip/clone {};
  msg_delay = callPackage ./ip/delay {};
  msg_dispatcher = callPackage ./ip/dispatcher {};
  msg_replace = callPackage ./ip/replace {};
