...
let
  ...
  crates = import ./crates.nix { inherit lib buildPlatform buildRustCrate fetchgit; }; in
crates // rec {
  rustfbp_0_3_34 = { features?(crates.rustfbp_0_3_34_features {}) }: (crates.rustfbp_0_3_34_ {
    dependencies = mapFeatures features ([ crates.env_logger_0_5_8 libloading_0_5_0 crates.threadpool_1_7_1 ]);
  }).override (args: {
