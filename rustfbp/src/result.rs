...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Error::OutputPortNotConnected(ref c, ref p) => write!(f, "OutputSender : Port {} of component {} not connected", p, c),
            Error::ArrayOutputPortNotConnected(ref c, ref p, ref s) => write!(f, "OutputSender : Selection {} Port {} of component {} not connected", s, p, c),
            Error::ComponentNotFound(ref c) => write!(f, "Scheduler error : Component {} not found", c),
            Error::PortNotFound(ref c, ref p) => write!(f, "Component error : Port {} of component {} not found", p, c),
            Error::SelectionNotFound(ref c, ref p, ref s) => write!(f, "Component error : Selection {} on port {} of component {} not found", s, p, c),
            Error::CannotRemove(ref c) => write!(f, "Scheduler error : Cannot remove the component {}", c),
