...
self = rec { # use one line only to insert a component (utils/new_component.py sorts this list)
  ...
  fsh = callPackage ./shells/fsh {}; # special name for the main build product
  ...
  shells_fsh_generator = callPackage ./shells/fsh/generator {};
  shells_fsh_generator_nix = callPackage ./shells/fsh/generator/nix {};
  shells_fsh_lexer = callPackage ./shells/fsh/lexer {};
  shells_fsh_lexer_pipe = callPackage ./shells/fsh/lexer/pipe {};
  shells_fsh_lexer_tokenize = callPackage ./shells/fsh/lexer/tokenize {};
  shells_fsh_parser = callPackage ./shells/fsh/parser {};
  shells_fsh_parser_verify = callPackage ./shells/fsh/parser/verify {};
