...
component! {
    nucleus_flow_vm, contracts(path, fbp_graph, option_path)
...
fn add_graph(component: &nucleus_flow_vm, mut graph: &mut Graph, new_graph: fbp_graph::Reader, name: &str) -> Result<()> {
