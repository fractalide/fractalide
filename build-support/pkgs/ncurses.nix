{ pkgs, lib, stdenv ? pkgs.pkgsi686Linux.stdenv, fetchurl
...
let
  libc_32bit = pkgs.pkgsi686Linux.stdenv.cc.libc;
...
stdenv.mkDerivation rec {
  ...
  meta = {
    ...
    maintainers = [ lib.maintainers.sjmackenzie ];
  };
